  ...
  <body>
    ...
    <div class="page">
            ...
            <div class="rd-navbar-inner-outer">
              <div class="rd-navbar-inner">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="index.html"><img class="brand-logo-dark" src="images/logo2.png" alt="" width="198" height="66"/></a></div>
                </div>
                <div class="rd-navbar-right rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-contacts-2">
                      ...
                      <li>
                        <div class="unit unit-spacing-xs">
                          ...
                          <div class="unit-body"><a class="address" href="#">Cheongpa-ro 47-gil, Cheongpa-dong 2-ga, Yongsan-gu, Seoul</a></div>
                        </div>
                      </li>
                    </ul>
                  ...
                  <div class="rd-navbar-main">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="keyword.php">인재상 적합도 분석</a>
                      </li>
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="recommend.php">문장 추천 서비스</a>
                      </li>
      ...
      <section class="bg-gray-7">
        <div class="container">
          <h3 class="breadcrumbs-custom-title">Recommend</h3>
      ...
      <section class="section section-sm section-first bg-default section-style-2 text-md-left">
		...
		<img src="images/step1.png" alt="" width="600" height="60" style="margin-left:8%; margin-top:6%;"/>
		</div>
		<br><br>
              <form method="post" action="recom_table.php">
              <ul class="list-xl box-typography"><h6>
						<li><input type = "radio" name = "box" value = "팀워크" required> 팀워크 </li>
						<li><input type = "radio" name = "box" value = "전문성" > 전문성  </li>
						<li><input type = "radio" name = "box" value = "신뢰" > 신뢰  </li>
						<li><input type = "radio" name = "box" value = "도전" > 도전</li>
						<li><input type = "radio" name = "box" value = "열정" > 열정</li>
						<li><input type = "radio" name = "box" value = "책임감"> 책임감</li>
						<li><input type = "radio" name = "box" value = "창의성" > 창의성 </li>
						<li><input type = "radio" name = "box" value = "글로벌" > 글로벌</li>
						<br>
						<input class="button button-xl button-primary button-winona" type="submit" value="확인" style="margin-left:60%;">
