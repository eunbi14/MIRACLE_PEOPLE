          ...
          <div class="tabs-custom row row-50 justify-content-center flex-lg-row-reverse text-center text-md-left" id="tabs-4">
            <div class="col-lg-4 col-xl-3">
              ...
              <ul class="nav list-category list-category-down-md-inline-block">
                ...
                <li class="list-category-item wow fadeInRight" role="presentation" data-wow-delay=".1s"><a class="active" data-toggle="tab" style="pointer-events: none;">Step 2. 자기소개서 입력</a></li>
            ...
            <div class="col-lg-8 col-xl-9">
              ...
              <div class="tab-content tab-content-1">
                ...
                <h4>STEP 2</h4>
                  ...
                  </p><img src="images/step2.png" alt="" width="600" height="60" style="margin-left:7%;" style="margin-top:10%;"/></div>
                  <html lang="ko">
				  <head>
				  <meta charset="utf-8">
				    <title>HTML</title>
				  ...
				  <body>
					...
					<?php $no = $_POST['box'];
					 ?>
				      <p><textarea id="cover" cols="80" rows="40" name="t"></textarea></p>
					<input type=hidden name="box" value="<?php echo $_POST['box'];?>">
<!--
                                      <p><input type="submit" value="분석하기" class="button button-xl button-primary button-winona" style="margin-left:110%; margin-top:-185%;"></p>
-->
                                      <p><input type="submit" value="분석하기" class="button button-xl button-primary button-winona" style="margin-left:110%; filter:Alpha(margin-top:-120%);margin-top:-185%;"></p>
				    </form>
				  </body>
				</html>
				<!--</form>-->
