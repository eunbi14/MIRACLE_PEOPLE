...
<!--	<script type="text/javascript">
	        var = cover_Letter;
                ...
                document.getElementById('result').innerHTML = cover_Letter;
                document.write("A");
	</script>-->
      ...
      <section class="section section-lg bg-default">
          ...
          <div class="tabs-custom row row-50 justify-content-center flex-lg-row-reverse text-center text-md-left" id="tabs-4">
            <div class="col-lg-4 col-xl-3">
              ...
              <ul class="nav list-category list-category-down-md-inline-block">
                <li class="list-category-item wow fadeInRight" role="presentation" data-wow-delay="0s"><a class="active" data-toggle="tab" style="pointer-events: none;" >Step 1. 인재상 키워드 선택</a></li>
		...
		<li class="list-category-item wow fadeInRight" role="presentation" data-wow-delay=".2s"><a data-toggle="tab" style="pointer-events: none; color: gray;">Step 3. 분석결과</a></li>		
<br>	
	</ul>
            ...
            <div class="col-lg-8 col-xl-9">
              ...
              <div class="tab-content tab-content-1">
                <div class="tab-pane fade show active" id="tabs-4-1">
                  ...
                  </p><img src="images/step1.png" alt="" width="600" height="60" style="margin-left:7%;"/></div>
                  <br>
               ...
               <li>
                  ...
                  <input type = "radio" name = "box" value = "팀워크" required> 팀워크 </li>
		...
		<li><input type = "radio" name = "box" value = "책임감" > 책임감 </li>
                  ...
                  var temp = $('input[name="box"]:checked').val();
                  alert("["+temp+"]이/가 선택되었습니다.\nStep2 자기소개서 입력으로 이동해주세요.");
                	  });
